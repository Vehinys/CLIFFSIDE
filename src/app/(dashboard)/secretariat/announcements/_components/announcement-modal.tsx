...
interface Props {
  ...
  title: string;
  initialData?: Parameters<typeof AnnouncementForm>[0]["initialData"];
  action: Parameters<typeof AnnouncementForm>[0]["action"];
}

export function AnnouncementModal({ open, onOpenChange, title, initialData, action }: Props) {
