...
interface Props {
  ...
  title: string;
  initialData?: Parameters<typeof NoteForm>[0]["initialData"];
  action: Parameters<typeof NoteForm>[0]["action"];
}

export function NoteModal({ open, onOpenChange, title, initialData, action }: Props) {
