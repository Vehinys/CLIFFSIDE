  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-bg px-4 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        <div className="absolute bottom-0 right-1/4 w-64 h-64 rounded-full bg-primary/3 blur-2xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted">StoryLife — Création de compte</p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-surface p-6 shadow-2xl shadow-black/50">
          ...
          <div className="mt-4 text-center text-sm text-muted">
            Déjà un compte ?{" "}
            <Link href="/login" className="text-primary hover:underline transition-opacity hover:opacity-80">
              Se connecter
            </Link>
          </div>
        </div>
