      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/5 bg-surface/40 backdrop-blur-xl p-8 shadow-2xl ring-1 ring-inset ring-white/10">
          ...
          <div className="mb-8 border-b border-white/5 pb-4">
            <h2 className="text-xl font-bold text-white tracking-wide">Nouveau Dossier</h2>
            <p className="text-sm text-muted mt-1">Remplissez vos informations pour rejoindre le protocole.</p>
          </div>

          <form action={action} className="space-y-6">
            <div className="space-y-2 group">
              <Label htmlFor="name" className="text-xs font-semibold uppercase tracking-wider text-muted group-focus-within:text-primary transition-colors" required>Pseudo (en jeu)</Label>
